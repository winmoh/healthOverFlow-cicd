        ...
        stage('code analysis using sonarQube code coverage'){
            ...
            steps{
                withSonarQubeEnv('sonarQube') {
                   sh "mvn clean  verify sonar:sonar -Dsonar.projectKey=cicd-Health-OverFlow -Dsonar.projectName='cicd Health OverFlow' -Dsonar.host.url=http://192.168.0.162:9000 -Dsonar.token=sqp_4cf5b086f7ad7657d43c93d2aa98ad77bd1bccb4"
                }
